    ...
    return (
        <div className="layout_header">
            ...
            <div className='header_second_container'>
                <ButtonWithIcon iconName='search_24' width={24} height={24} className='search_button' />
                <div className="phone_number_wrapper">
                    <Icon iconName='phone_24' width={24} height={24} />
                    <span>+ 374 10 59 23 23</span>
                </div>
                <ButtonWithTextAndIcon iconName="earth_20" width={20} height={20} text="ENG" className='language_button' />
